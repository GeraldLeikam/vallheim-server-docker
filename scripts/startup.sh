...
ARGUMENT_STRING=""
if [ -n ${SERVER_NAME} ]; then ARGUMENTS_STRING="${ARGUMENTS_STRING}-name \"${SERVER_NAME}\" "; else ARGUMENTS_STRING="${ARGUMENTS_STRING}-name \"${DEFAULT_SERVER_NAME}\" "; fi
if [ -n ${SERVER_PORT} ]; then ARGUMENTS_STRING="${ARGUMENTS_STRING}-port ${SERVER_PORT} "; else ARGUMENTS_STRING="${ARGUMENTS_STRING}-port ${DEFAULT_SERVER_PORT} "; fi
if [ -n ${WORLD_NAME} ]; then ARGUMENTS_STRING="${ARGUMENTS_STRING}-world \"${WORLD_NAME}\" "; else ARGUMENTS_STRING="${ARGUMENTS_STRING}-world \"${DEFAULT_WORLD_NAME}\" "; fi
